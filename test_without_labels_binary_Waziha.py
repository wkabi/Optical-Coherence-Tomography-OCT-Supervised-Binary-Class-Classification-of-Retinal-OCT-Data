...
parser.add_argument('--data_path', type=str, default='/home/shared/OCT_Laval_ETS_20220824/', help='path data')
#parser.add_argument('--csv_val', type=str, default='data/CNV_val_dataset_Waziha_binlabel.csv', help='path to val data csv')
parser.add_argument('--csv_test', type=str, default='data/OCT_Laval_CNV_Grad_20221116.csv', help='path to test data csv')
