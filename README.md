...
This repository will help you to train, validate and test OCT AI model for binary-class classification using retinal OCT images by employing deep learning (DL) methodology. 
